...
const displayData = {
  vi: {
    ...
    cancelConfirm: 'Ban co chac muon huy dat tour nay khong?\n\nChinh sach hoan tien (tinh theo ngay con lai truoc chuyen di):\n- Con tu 7 ngay tro len: hoan 100%\n- Con 3-6 ngay: hoan 50%\n- Con duoi 3 ngay: khong hoan tien',
    cancelling: 'Dang huy...',
